  ...
  export default {
    ...
    methods: {
      ...
      async fetchProductReviews() {
        this.isLoading = true;
        try {
          const response = await axios.get(`${this.API_BASE_URL}/product-reviews`);
      ...
      async updateReview() {
        try {
          ...
          const response = await axios.put(
            `${this.API_BASE_URL}/product-reviews/${this.form.id}`,
            {
      ...
      async deleteReview(id) {
        ...
        try {
          this.isLoading = true;
          await axios.delete(`${this.API_BASE_URL}/product-reviews/${id}`);
